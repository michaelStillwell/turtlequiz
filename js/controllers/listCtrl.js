angular.module('app').controller('listCtrl', function(quizMetrics) {
    this.turtles = turtlesData;
    this.activeTurtle = {};
    this.search = '';
    this.quiz = quizMetrics;
    this.quizActive = this.quiz.quizActive;

    this.activateQuiz = () => { 
        quizMetrics.switchActive();
